...
pump_enable = Pin(14, Pin.OUT, Pin.PULL_UP, value=0)
led_channel_0_enable = Pin(33, Pin.OUT, Pin.PULL_UP, value=0)
led_channel_1_enable = Pin(32, Pin.OUT, Pin.PULL_UP, value=0)
